...
ages = pickle.load(open("./outliers/practice_outliers_ages_unix.pkl", "rb"))
net_worths = pickle.load(open("./outliers/practice_outliers_net_worths_unix.pkl", "rb"))
...
print("slope with outlier: {}, \n score with outlier: {}".format(slope, score))
...
if len(cleaned_data) > 0:
    ...
    try:
        ...
        slope = reg.coef_[0][0]
        score = reg.score(ages_test, net_worths_test)
        print("slope without outlier: {}, \n score without outlier: {}".format(slope, score))
